...
// все свойства передаются от родителя к ребенку/ если мы хотим передать свойства от ребенка родител,
// то надо прописать функцию через onClick или onChange? назвать эти функции можно хоть Зюзя, просто
// эти названия общеприняты
